...
Color deepPerpal200 = Colors.deepPurple.shade200;
Color deepPerpal = Colors.deepPurple;
Color deepred = Color.fromARGB(255, 143, 133, 133);
const Color golden = Color.fromRGBO(255, 168, 0, 1);
const Color lightgolden = Color.fromARGB(234, 249, 221, 161);
